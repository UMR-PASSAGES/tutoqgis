				...
				<div class="manip">
					...
					<figure>
						<a href="illustrations/1_3_fichiers.jpg" >
							<img src="illustrations/1_3_fichiers.jpg" alt="fichiers format SIG" width="500">
						</a>
					</figure>
				</div>
				<p class="note">Si dans Windows, vous ne voyez pas les extensions de tous les fichiers : dans la fenêtre, Outils &#8594; Options des dossiers, onglet Affichage, décocher la case "Masquer les extensions dont le type est connu".</p>
					...
					<h4>Format Shapefile ou SHP : un "standard"<a class="headerlink" id="I31a" href="#I31a"></a></h4>
					    ...
					    <figure>
						  <a href="illustrations/1_3_fichiers_shp.jpg" >
							 <img src="illustrations/1_3_fichiers_shp.jpg" alt="fichiers format shapefile" width="200">
						  </a>
					    </figure>
					    <p>La couche <em class="data">LA_DEPARTEMENT_S</em> est au format <b>shapefile</b> ou <b>SHP</b>, ainsi que les couches <em class="data">LA_LOCALITE_P</em>, <em class="data">LA_REGION_S</em> et <em class="data">TR_SEGMENT_ROUTIER_L</em>.</p>
    					...
    					<ul>
    						<li><b>PRJ</b> : contient le code du système de coordonnées et éventuellement de la projection, lisibles par les logiciels QGIS et ArcGIS</li>
    						<li><b>QPJ</b> : contient le code du système de coordonnées et éventuellement de la projection, lisible par le logiciel QGIS</li>
    					</ul>
    					<p>Le fichier QPJ contient plus d'informations que le fichier PRJ&nbsp;; néanmoins, QGIS crée également un fichier PRJ pour des raisons de compatibilité avec ArcGIS. Si les 2 fichiers sont présents, QGIS utilisera le QPJ. L'important est qu'il y ait au moins un des deux présents !</p>
					...
					<h4>Format GPKG (GeoPackage)<a class="headerlink" id="I31b" href="#I31b"></a></h4>
					   ...
					   <figure>
						  <a href="illustrations/1_3_fichiers_gpkg.jpg" >
							 <img src="illustrations/1_3_fichiers_gpkg.jpg" alt="fichiers format geopackage" width="220">
						  </a>
					    </figure>
					    <p>La couche <em class="data">departement_bretagne</em> est au format GeoPackage ou GPKG.</p>
					   ...
					   <p>Ce format léger est implémenté aujourd'hui dans la plupart des logiciels SIG ; les données IGN vecteur sont aujourd'hui pour la plupart fournies en GeoPackage.</p>
					...
					<h4>Format TAB (MapInfo)<a class="headerlink" id="I31c" href="#I31c"></a></h4>
 					    ...
 					    <figure>
						  <a href="illustrations/1_3_fichiers_tab.jpg" >
							 <img src="illustrations/1_3_fichiers_tab.jpg" alt="fichiers format TAB" width="160">
						  </a>
					    </figure>

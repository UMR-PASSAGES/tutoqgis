...
<div id="wrap">
	...
	<div id="container_main_sidebar">
		...
		<div class="main">
			<h1>IV.5  Lancer le géoréférencement</h1>
			...
			<h2>Vérification avant calage : les erreurs<a class="headerlink" id="IV51" href="#IV51"></a></h2>
			
			
				<h3>Erreur locale : en chaque point de contrôle<a class="headerlink" id="IV51a" href="#IV51a"></a></h3>
				...
				<h3>Erreur globale : Erreur Quadratique Moyenne<a class="headerlink" id="IV51b" href="#IV51b"></a></h3>
			...
			<h2>Lancement du géoréférencement<a class="headerlink" id="IV52" href="#IV52"></a></h2>
			...
			<h2>Vérification de la précision du calage<a class="headerlink" id="IV53" href="#IV53"></a></h2>
					
				<h3>Lecture de la carte et du rapport PDF<a class="headerlink" id="IV53a" href="#IV53a"></a></h3>
				...
				<h3>Vérification par superposition d'une autre couche<a class="headerlink" id="IV53b" href="#IV53b"></a></h3>

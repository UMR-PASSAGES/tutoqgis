		...
		<div class="main">
			<h2>XII.1  Introduction à la télédétection</h2>
			    <ul class="listetitres">
					<li><a href="#XII11">Données utilisées : image Sentinel-2</a>
					   <ul class="listesoustitres">
							<li><a href="#XII11a">Type de satellite</a></li>
                ...
                <h3>Données utilisées : image Sentinel-2<a class="headerlink" id="XII11" href="#XII11"></a></h3>
                    ...
                    L'image que nous allons utiliser ici est une <b>image Sentinel-2 acquise le 17 août 2021</b>. Nous allons commencer par essayer de répondre à 3 questions :
                    
                    <ul>
                        <li><b>Comment&nbp;?</b> Quel est le type de satellite, de produit, etc.</li>

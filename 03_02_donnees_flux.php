		...
		<div class="main">
			...
			<h3><a class="titre" id="III22">Ajout de données via un flux WMS : carte géologique</a></h3>
				...
				<div class="manip">
					...
					<ul>
						<li class="espace">Après avoir vérifié que votre connexion est bien sélectionnée dans la liste déroulante en haut de la fenêtre, cliquez sur <b>Connexion</b>

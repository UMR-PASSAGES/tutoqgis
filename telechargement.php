	...
	<div id="container_main_sidebar">
		...
		<div class="main">
			...
			<h2>Téléchargement du tutoriel au format PDF</h2>
				...
				<p><a download href="exports_pdf/tutoqgis.pdf">Tout le tutoriel au format PDF (37 Mo)</a></p>
				<p><a download href="exports_pdf/tutoqgis_01_priseenmain.pdf">PDF de la partie I : prise en main (3,1 Mo)</a></p>
				<p><a download href="exports_pdf/tutoqgis_02_geodesie.pdf">PDF de la partie II : géodésie (2,4 Mo)</a></p>
				<p><a download href="exports_pdf/tutoqgis_03_recherche_donnees.pdf">PDF de la partie III : recherche et ajout de données (5,2 Mo)</a></p>
				<p><a download href="exports_pdf/tutoqgis_04_georeferencement.pdf">PDF de la partie IV : géoréférencement (5,3 Mo)</a></p>
				<p><a download href="exports_pdf/tutoqgis_05_numerisation.pdf">PDF de la partie V : numérisation (5,7 Mo)</a></p>
				<p><a download href="exports_pdf/tutoqgis_06_requetes.pdf">PDF de la partie VI : requêtes (3,6 Mo)</a> </p>
				<p><a download href="exports_pdf/tutoqgis_07_calcul_champs.pdf">PDF de la partie VII : calcul de champs (1,7 Mo)</a></p>
				<p><a download href="exports_pdf/tutoqgis_08_jointures.pdf">PDF de la partie VIII : jointures (2,4 Mo)</a> </p>
				<p><a download href="exports_pdf/tutoqgis_09_analyse_spatiale.pdf">PDF de la partie IX : analyse spatiale (3,4 Mo)</a></p>
				<p><a download href="exports_pdf/tutoqgis_10_miseenpage.pdf">PDF de la partie X : représentation et mise en page (4,7 Mo)</a></p>

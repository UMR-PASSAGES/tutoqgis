	...
	<div id="container_main_sidebar">
		...
		<div class="main">
			<h1>Téléchargement des données</h1>
				...
				<p><a download href="donnees/TutoQGIS_Donnees.zip">Toutes les données (280,2 Mo)</a></p>
				...
				<p><a download href="donnees/TutoQGIS_05_Numerisation.zip">Données de la partie V : numérisation (20,2 Mo)</a></p>
				<p><a download href="donnees/TutoQGIS_06_Requetes.zip">Données de la partie VI : requêtes (8,9 Mo)</a></p>
				<p><a download href="donnees/TutoQGIS_07_Champs.zip">Données de la partie VII : calcul de champs (4,2 Mo)</a></p>
				<p><a download href="donnees/TutoQGIS_08_Jointures.zip">Données de la partie VIII : jointures (85,7 Mo)</a></p>
				<p><a download href="donnees/TutoQGIS_09_AnalyseSpat.zip">Données de la partie IX : analyse spatiale (29,7 Mo)</a></p>
			...
			<h1>Téléchargement du tutoriel au format PDF</h1>
				...
				<p><a download href="exports_pdf/tutoqgis.pdf">Tout le tutoriel au format PDF (40,1 Mo)</a></p>
				...
				<p><a download href="exports_pdf/tutoqgis_03_recherche_donnees.pdf">PDF de la partie III : recherche et ajout de données (5,3 Mo)</a></p>
				<p><a download href="exports_pdf/tutoqgis_04_georeferencement.pdf">PDF de la partie IV : géoréférencement (5,1 Mo)</a></p>
				<p><a download href="exports_pdf/tutoqgis_05_numerisation.pdf">PDF de la partie V : numérisation (5,6 Mo)</a></p>
				<p><a download href="exports_pdf/tutoqgis_06_requetes.pdf">PDF de la partie VI : requêtes (3,4 Mo)</a> </p>
				<p><a download href="exports_pdf/tutoqgis_07_calcul_champs.pdf">PDF de la partie VII : calcul de champs (1,5 Mo)</a></p>
				<p><a download href="exports_pdf/tutoqgis_08_jointures.pdf">PDF de la partie VIII : jointures (2,2 Mo)</a> </p>
				<p><a download href="exports_pdf/tutoqgis_09_analyse_spatiale.pdf">PDF de la partie IX : analyse spatiale (6,9 Mo)</a></p>
				<p><a download href="exports_pdf/tutoqgis_10_miseenpage.pdf">PDF de la partie X : représentation et mise en page (4,9 Mo)</a></p>
				<p><a download href="exports_pdf/tutoqgis_11_automatisation.pdf">PDF de la partie XI : automatisation de traitements (1,5 Mo)</a></p>

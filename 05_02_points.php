...
<div id="wrap">
	...
	<div id="container_main_sidebar">
		...
		<div class="main">
			<h1>V.2  Ajout de points dans une couche</h1>
			...
			<h2>Rendre une couche éditable<a class="headerlink" id="V21" href="#V21"></a></h2>
				...
				<div class="manip">
					...
					<p>sélectionnez la couche dans la table des matières puis
						<a class="thumbnail_bottom" href="#thumb">Menu Couche &#8594; Basculer en mode édition
							<span>
								<img src="illustrations/5_2_edition_menu.jpg" alt="Menu Couche, Basculer en mode édition" height="500" >
							</span>
						</a>
					.</p>
				</div>
			...
			<h2>Ajout d'un point<a class="headerlink" id="V22" href="#V22"></a></h2>
				...
				<div class="manip">
					...
					<figure>
						<a href="illustrations/5_2_tous_les_points.jpg" >
							<img src="illustrations/5_2_tous_les_points.jpg" alt="Carte avec toutes les écoles et postes numérisées" width="500">
						</a>
					</figure>
					<p><img class="icone" src="illustrations/5_2_sauv_icone.jpg" alt="icône sauvegarder les modifications" >N'oubliez pas de sauvegarder vos modifications en sélectionnant la couche puis en cliquant sur l’icône <b>sauvegarder les modifications</b>.</p>
			...
			<h2>Modification d'un point<a class="headerlink" id="V23" href="#V23"></a></h2>
				...
				<h3>Déplacement<a class="headerlink" id="V23a" href="#V23a"></a></h3>
				...
				<h3>Modification des données attributaires<a class="headerlink" id="V23b" href="#V23b"></a></h3>
					...
					<div class="manip">
						...
						<figure>
                        	<a href="illustrations/5_2_modif_donnees_attributaires.jpg" >
                        		<img src="illustrations/5_2_modif_donnees_attributaires.jpg" alt="Modification de données attributaires" width="110">
                        	</a>
                        </figure>
					</div>
					
			<h2>Quitter le mode édition<a class="headerlink" id="V24" href="#V24"></a></h2>
				...
				<div class="manip">
					...
					<figure>
					   <a href="illustrations/5_2_quitter_edition.jpg">

...
<div id="wrap">
	...
	<div id="container_main_sidebar">
		...
		<div class="main">
			<h1>XI.1  Traitement de base pour une seule couche</h1>
				...
				<div class="manip">
					...
					<p>Pour découper la couche de routes par la commune :
					   <a class="thumbnail_bottom" href="#thumb">Boîte à outils &#8594; Recouvrement de vecteur &#8594; Couper
                        	<span>
                        		<img src="illustrations/11_01_couper_menu.jpg" alt="Emplacement de l'outil Couper dans la boîte à outils" width="280" >
                        	</span>
                        </a> 
					</p>
					<figure>
							<a href="illustrations/11_01_decouper_fenetre.jpg" >
								<img src="illustrations/11_01_decouper_fenetre.jpg" alt="Fenêtre de l'outil Couper" width="600">
							</a>
					</figure>

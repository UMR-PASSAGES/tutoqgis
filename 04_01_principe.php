...
<div id="wrap">
	...
	<div id="container_main_sidebar">
		...
		<div class="main">
			<h1>IV.1  Principe du géoréférencement</h1>
			...
			<h2>Qu'est-ce que le géoréférencement ?<a class="headerlink" id="IV11" href="#IV11"></a></h2>
			...
			<h2>Géoréférencer par rapport à quoi ? Deux méthodes<a class="headerlink" id="IV12" href="#IV12"></a></h2>
				...
				<h3>En se basant sur les informations contenues dans l'image<a class="headerlink" id="IV12a" href="#IV12a"></a></h3>
				...
				<h3>En se basant sur des informations contenues dans une autre couche<a class="headerlink" id="IV12b" href="#IV12b"></a></h3>

...
<div id="wrap">
	...
	<div id="container_main_sidebar">
		...
		<div class="main">
			<h2>VII.3  Calcul de champs</h2>
				<ul class="listetitres">
					<li><a href="#VII31">Comment fonctionne la calculatrice de champ ?</a></li>
					<li><a href="#VII32">Calcul de géométrie : l'exemple de la surface</a>
						<ul class="listesoustitres">
							<li><a href="#VII32a">Calcul de la surface</a></li>
							<li><a href="#VII32b">Vérification</a></li>
						</ul>
					</li>
					<li><a href="#VII33">Quelques exemples supplémentaires de calculs</a>
						<ul class="listesoustitres">
							<li><a href="#VII33a">Opérations mathématiques : calcul de densité</a></li>
							<li><a href="#VII33b">Opérations sur du texte : extraction des codes et noms de régions et départements</a></li>
							<li><a href="#VII33c">Opérations sur du texte : concaténation</a></li>
						</ul>
					</li>
				</ul>
				<br>
			...
			<h3><a class="titre" id="VII31">Comment fonctionne la calculatrice de champ ?</a></h3>
				...
				<div class="manip">
					...
					<figure>
						<img src="illustrations/tous/7_3_BO_table_calc.png" alt="barre d'outils de la table attributaire, avec icône de la calculatrice de champs entourée en rouge" height="33" >
					</figure>
				</div>
				
				<p>La fenêtre suivante s'ouvre :</p>
				<figure>
					<a href="illustrations/tous/7_3_calc_fenetre.png" >
						<img src="illustrations/tous/7_3_calc_fenetre.png" alt="Fenêtre de la calculatrice de champs" height="500" >
					</a>
				</figure>
			...
			<h3><a class="titre" id="VII32">Calcul de géométrie : l'exemple de la surface</a></h3>
			
				<h4><a class="titre" id="VII32a">Calcul de la surface</a></h4>
			
					<p>Nous allons ici calculer la surface de chaque département en km<sup>2</sup>.</p>
					<div class="manip">
						<figure>
							<a href="illustrations/tous/7_3_calc_fenetre_surface.png">
								<img src="illustrations/tous/7_3_calc_fenetre_surface.png" alt="Fenêtre de la calculatrice de champs, pour calculer la surface d'un département en km2" height="480" >
							</a>
						</figure>
						<ul>
				...
				<h4><a class="titre" id="VII32b">Vérification</a></h4>
						
					<div class="manip">
						<p><img class="iconemid" src="illustrations/tous/7_3_mesure_icone.png" alt="icône mesurer une aire" >Vous pouvez vérifier votre calcul au moyen de l'outil <b>Mesurer une aire</b> : </p>
						<figure>
							<img src="illustrations/tous/7_3_aire_selection.png" alt="Sélection de l'outil mesurer une aire dans la liste" height="100" >
						</figure>
						...
						<figure>
							<a href="illustrations/tous/7_3_verif_surf.png" >
								<img src="illustrations/tous/7_3_verif_surf.png" alt="Vérification de la surface au moyen de l'outil mesurer une aire" height="320" >
							</a>
						</figure>
					</div>
			...
			<h3><a class="titre" id="VII33">Quelques exemples supplémentaires de calculs</a></h3>
				...
				<h4><a class="titre" id="VII33a">Opérations mathématiques : calcul de densité</a></h4>
					...
					<div class="manip">
						...
						<figure>
							<a href="illustrations/tous/7_3_calc_densite.png" >
								<img src="illustrations/tous/7_3_calc_densite.png" alt="Fenêtre de la calculatrice de champ, calcul de la densité" height="420" >
							</a>
						</figure>
						<ul>
						...
						<figure>
							<img src="illustrations/tous/7_3_densite_table.png" alt="Table attributaire avec les 3 colonnes population, surface et densité" height="300" >
						</figure>
					</div>
				...
				<h4><a class="titre" id="VII33b">Opérations sur du texte : extraction des codes et noms de régions et départements</a></h4>
					...
					<div class="manip">
						<p>Si ce n'est pas déjà fait, ouvrez la table attributaire de la couche <em class="data">communes_NordPasDeCalais_calcul</em>. Ouvrez la calculatrice de champs :</p>
						<figure>
							<a href="illustrations/tous/7_3_calc_codedept.png" >
								<img src="illustrations/tous/7_3_calc_codedept.png" alt="Calculatrice de champ : calcul du code du département" height="450" >
							</a>
						</figure>
						<ul>
						...
						<figure>
							<img src="illustrations/tous/7_3_table_codedept.png" alt="extrait de la table avec les champs DEPT et CODE_DEPT" height="200" >
						</figure>
					</div>
					...
					<div class="manip">
						...
						<figure>
							<a href="illustrations/tous/7_3_calc_nomdept.png" >
								<img src="illustrations/tous/7_3_calc_nomdept.png" alt="Calculatrice de champ : calcul du nom du département" height="460" >
							</a>
						</figure>
						<div class="question">
				...
				<h4><a class="titre" id="VII33c">Opérations sur du texte : concaténation</a></h4>
					...
					<div class="manip">
						...
						<figure>
							<a href="illustrations/tous/7_3_calc_codeinsee.png" >
								<img src="illustrations/tous/7_3_calc_codeinsee.png" alt="Calculatrice de champ : calcul du code INSEE" height="420" >
							</a>
						</figure>
						<ul>
						...
						<figure>
							<img src="illustrations/tous/7_3_codeinsee_table.png" alt="Table attributaire avec les 3 colonnes CODE_DEPT, CODE_COMM et CODE_INSEE" height="200" >
						</figure>
						<p class="note">Il est aussi possible d'utiliser la formule <b>concat ( "CODE_DEPT",  "CODE_COMM" )</b>, pour le même résultat.</p>
					</div>
					
				<br>
				<a class="prec" href="07_02_gestionnaire_table.php">chapitre précédent</a>

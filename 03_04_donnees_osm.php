		...
		<div class="main">
			...
			<h3><a class="titre" id="III43">Télécharger des données OpenStreetMap</a></h3>
                ...
                <div class="manip">
                     ...
                     <figure>
                    	<a href="illustrations/tous/3_4_geofabrik_southamerica.png" >
                    		<img src="illustrations/tous/3_4_geofabrik_southamerica.png" alt="lien pour télécharger les données du Suriname au format SHP sur Geofabrik" width="80%">
                    	</a>
                     </figure>
                     <figure>
                    	<a href="illustrations/tous/3_4_geofabrik_suriname.png" >
                    		<img src="illustrations/tous/3_4_geofabrik_suriname.png" alt="lien pour télécharger les données du Suriname au format SHP sur Geofabrik" width="80%">
                    	</a>
                    </figure>
                ...
                <h3><a class="titre" id="III44">Représenter des données OpenStreetMap</a></h3>
                    ...
                    <div class="manip">
                        ...
                        <figure>
                        	<a href="illustrations/tous/3_4_charger_style_fenetre.png" >
                        		<img src="illustrations/tous/3_4_charger_style_fenetre.png" alt="Sélectionner un style depuis un fichier" width="75%">
                        	</a>
                        </figure>
			    ...
			    <div class="manip">
			        ...
			        <figure>
                    	<a href="illustrations/tous/3_4_quickosm_fenetre.png" >
                    		<img src="illustrations/tous/3_4_quickosm_fenetre.png" alt="Fenêtre de QuickOSM, choix des options" width="75%">
                    	</a>
                    </figure>

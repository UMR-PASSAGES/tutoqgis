...
<div id="wrap">
	...
	<div id="container_main_sidebar">
		...
		<div class="main">
			...
			<h2>Préparation des données : découpage d'un raster<a class="headerlink" id="IX21" href="#IX21"></a></h2>
			...
			<h2>Explorer les données en modifiant le mode de représentation<a class="headerlink" id="IX22" href="#IX22"></a></h2>
			    ...
			    <h3>Répartition des valeurs : histogramme de fréquence<a class="headerlink" id="IX22a" href="#IX22a"></a></h3>
			    ...
			    <h3>La valeur des pixels sans valeur<a class="headerlink" id="IX22b" href="#IX22b"></a></h3>
			    ...
			    <h3>Modifier le style pour explorer les données<a class="headerlink" id="IX22c" href="#IX22c"></a></h3>
			...
			<h2>Manipuler les données : extraction de valeurs<a class="headerlink" id="IX23" href="#IX23"></a></h2>
			...
			<h2>Exemples d'opérations sur des données d'altitude<a class="headerlink" id="IX24" href="#IX24"></a></h2>
			    ...
			    <h3>Création de courbes de niveau<a class="headerlink" id="IX24a" href="#IX24a"></a></h3>
    			...
    			<h3>Projection d'un raster<a class="headerlink" id="IX24b" href="#IX24b"></a></h3>
  				...
  				<h3>Calcul de pente à partir du raster projeté<a class="headerlink" id="IX24c" href="#IX24c"></a></h3>

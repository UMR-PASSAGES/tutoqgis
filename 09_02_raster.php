		...
		<div class="main">
			<h2>IX.2  Analyse spatiale : quelques exemples d'opérations sur des données raster</h2>
				<ul class="listetitres">
					<li><a href="#IX21">Découpage d'un raster</a></li>
					<li><a href="#IX22">Création de courbes de niveaux</a>
					</li>
					<li><a href="#IX23">Création d'une couche de pente à partir de l'altitude</a>
						<ul class="listesoustitres">
							<li><a href="#IX23a">Projection d'un raster</a></li>
							<li><a href="#IX23b">Calcul de pente à partir du raster projeté</a></li>
						</ul>
					</li>
				</ul>
				<br>
			...
			<h3><a class="titre" id="IX21">Découpage d'un raster</a></h3>
				...
				<div class="manip">
					<p>Ouvrez un nouveau projet QGIS. <a href="01_02_info_geo.php#I24" >Ajoutez la couche raster</a> <em class="data">srtm_21_09.tif</em> située dans <b>TutoQGIS_09_AnalyseSpat/donnees</b>.</p>
					...
					<p>Rendez-vous dans le
						<a class="thumbnail_bottom" href="#thumb">Menu Raster &#8594; Extraction &#8594; Découper
							<span>
								<img src="illustrations/tous/9_2_raster_decouper_menu.png" alt="Menu Raster, Extraction, Découper" height="200" >
							</span>
						</a>
					:</p>
					<figure>
					...
					<ul>
						<li class="espace"><b>Fichier source :</b> sélectionnez <em class="data">srtm_21_09</em></li>
						<li class="espace"><b>Fichier en sortie :</b> cliquez sur <b>Sélection...</b>, choisissez où la nouvelle couche sera créée, et son nom : <em class="data">srtm_jamaique</em></li>
						<li class="espace"><b>Valeur nulle :</b> laissez la case décochée</li>
						<li class="espace"><b>Mode de découpage :</b> choisissez <b>Emprise</b></li>
						<li class="espace">Vérifiez que la case <b>Charger dans la carte une fois terminé</b> soit bien cochée</li>
						<li class="espace">Il faut ensuite dessiner l'emprise à garder, toujours dans l'outil de découpage. Dessinez un rectangle autour de l'île de la Jamaïque :</li>
				...
				<p>Notez qu'il est également possible de découper un raster suivant une couche de polygones, en utilisant l'option <b>couche de masquage</b>. Vous pouvez aussi directement rentrer à la main les coordonnées de l'emprise à conserver.</p>
			
			
			<h3><a class="titre" id="IX22">Création de courbes de niveaux</a></h3>
			...
			<h3><a class="titre" id="IX23">Création d'une couche de pente à partir de l'altitude</a></h3>
				...
				<h4><a class="titre" id="IX23a">Projection d'un raster</a></h4>
				...
				<h4><a class="titre" id="IX23b">Calcul de pente à partir du raster projeté</a></h4>

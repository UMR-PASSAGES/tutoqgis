		  ...
		  <h1 class="hide_for_pdf">VI.  Sélectionner des données : les requêtes</h1>
			...
			<h3>Quelques opérateurs<a class="headerlink" id="VI14" href="#VI14"></a></h3>
				...
				<div class="manip">
					...
					<p>Pour lire les noms des communes sélectionnées dans la table attributaire, vous pouvez sélectionner l'option <b>Ne montrer que les entités sélectionnées</b> en bas de la table attributaire. N'oubliez pas de revenir à <b>Montrer toutes les entités</b> ensuite&nbsp;!</p>
				</div>

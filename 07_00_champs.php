		...
		<div class="main">
			...
			<p>Notions abordées :</p>
				<ul>
					...
					<li>Renommer des champs</li>
					<li>Modifier l'ordre des champs</li>
					<li>Calcul des valeurs d'un champ</li>
				</ul>
			...
			<br>
			<a class="suiv" href="07_01_creation_suppression.php">démarrer</a>

...
<div id="wrap">
	...
	<div id="container_main_sidebar">
		...
		<div class="main">
			...
			<h2>Comment fonctionne la calculatrice de champ ?<a class="headerlink" id="VII21" href="#VII21"></a></h2>
			...
			<h2>Calcul de géométrie : l'exemple de la surface<a class="headerlink" id="VII22" href="#VII22"></a></h2>
			
				<h3>Calcul de la surface<a class="headerlink" id="VII22a" href="#VII22a"></a></h3>
				...
				<h3>Vérification<a class="headerlink" id="VII22b" href="#VII22b"></a></h3>
			...
			<h2>Quelques exemples supplémentaires de calculs<a class="headerlink" id="VII23" href="#VII23"></a></h2>
				...
				<h3>Opérations mathématiques : calcul de densité<a class="headerlink" id="VII23a" href="#VII23a"></a></h3>
				...
				<h3>Opérations sur du texte : extraction<a class="headerlink" id="VII23b" href="#VII23b"></a></h3>
				...
				<h3>Pour aller plus loin : utiliser une expression conditionnelle avec CASE<a class="headerlink" id="VII23c" href="#VII23c"></a></h3>

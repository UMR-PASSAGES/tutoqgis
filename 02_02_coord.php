		  ...
		  <h1 class="hide_for_pdf">II.  Géodésie</h1>
			...
			<h3>Systèmes de coordonnées<a class="headerlink" id="II21" href="#II21"></a></h3>
				...
				<h4>Qu'est-ce qu'un système de coordonnées ?<a class="headerlink" id="II21a" href="#II21a"></a></h4>
					...
					<figure>
						<a href="illustrations/2_2_coord_geographiques.svg" >
							<img src="illustrations/2_2_coord_geographiques.jpg" alt="coordonnées géographiques" width="300">
						</a>
					</figure>
				...
				<h4>Trois grands types de projections : cylindriques, coniques et azimutales<a class="headerlink" id="II22b" href="#II22b"></a></h4>					
					...
					<figure>
						<a href="http://commons.wikimedia.org/wiki/File:Projection_cylindrique.jpg#file" >
							<img src="illustrations/2_2_projection_cylindrique.jpg" alt="Projection cylindrique, conique et azimutale" width="150">
						</a>
						<a href="http://commons.wikimedia.org/wiki/File:Projection_conique.jpg" >
							<img src="illustrations/2_2_projection_conique.jpg" alt="Projection cylindrique, conique et azimutale" width="155">
						</a>
						<a href="http://commons.wikimedia.org/wiki/File:Projection_azimutale_stereographique.jpg" >
							<img src="illustrations/2_2_projection_azimutale.jpg" alt="Projection cylindrique, conique et azimutale" width="250">
						</a>
				...
				<h4>Quelques exemples de projections<a class="headerlink" id="II22d" href="#II22d"></a></h4>
					...
					<figure>
						<a href="http://commons.wikimedia.org/wiki/File:Tissot_indicatrix_world_map_Mercator_proj.svg" >
							<img src="illustrations/2_2_mercator.jpg" alt="projection de Mercator" width="300">
						</a>
					...
					<figure>
						<a href="http://commons.wikimedia.org/wiki/File:Tissot_indicatrix_world_map_Gall-Peters_equal-area_proj.svg" >
							<img src="illustrations/2_2_peters.jpg" alt="projection de Peters" width="400">
						</a>
					...
					<figure>
						<a href="illustrations/2_2_lambert93.svg" >
							<img src="illustrations/2_2_lambert93.jpg" alt="projection conique conforme lambert 93" width="400">
						</a>
					...
					<br>	
					<figure>
						<a href="illustrations/2_2_azim.svg" >
							<img src="illustrations/2_2_azim.jpg" alt="projection azimutale équidistante pôle sud" width="350">
						</a>
